...
#middleware is like a gate that allows whether code can proceed forward (access)
...
#below is a list of domains we want to whitelist
origins = [
    "http://localhost:5173",
    "http://127.0.0.1:5173"
]
...
#the above says override CORS settings with my settings
#credentials accepts cookies from the client
