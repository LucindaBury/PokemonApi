...
""" Pydantic is a package - here we are going to reuse what pydantic has already written for us - inheritance - we will inherit that code.
This model is known as a parent model. It inherits a class.
We want to encapsulate all the above code as one. """